...
public class IonTemplatePlugin extends JavaPlugin {
    ...
    public void onDisable() {
        if (hotConfig != null) hotConfig.stop();
    ...
    public IonDatabase getDatabase() { return database; }
    public IonRedis getRedis() { return redis; }
    public TemplateEconomyProvider getEconomyProvider() { return economyProvider; }
